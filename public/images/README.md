...
Déposez ici les visuels définitifs du site Comores Airways.
...
- Photos : `.jpg` ou `.webp`, 1600 px de large environ.
- Logo : `.svg` ou `.png` avec fond transparent.
- Poids : idéalement moins de 500 Ko par image pour garder le site rapide.
